...
\begin{tabular}{| c | c | c |}
   ...
   \hline
   $\kappa$ & thermal conductivity & $0.5$ $W/(m \cdot K)$                   \\
   \hline
   H        & enthalpy             & $1000$ $J/(K \cdot kg)$                  \\
   \hline
\end{tabular}
...
- future work: overlapping local predictions -> resolve with global city-wide model
