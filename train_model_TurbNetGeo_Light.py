...
def run_epoch(rank, world_size):
    ...
    model_dir = base_dir + "results/" + "TurbNetG_Light" + timestamp + "_batch_size_" + str(batch_size) + "_total_batch_groups_" + str(total_batch_groups) + "_channelExponent_" + str(channelExponent)
    ...
    print("Initialized TurbNetGeo_Light with {} trainable params ".format(params))
