...
class TurbNetG(nn.Module):
    ...
    # generator model
class TurbNetG_Light(nn.Module):
    def __init__(self, channelExponent=5, dropout=0.0):
        super(TurbNetG_Light, self).__init__()
        channels = int(2**channelExponent + 0.5)
        print("Initial Features: ", channels)
...
class TurbNetG_noCat(nn.Module):
    def __init__(self, channelExponent=6, dropout=0.0):
        super(TurbNetG_noCat, self).__init__()
        channels = int(2**channelExponent + 0.5)
        #print("Initial Features: ", channels)
...
class TurbNetG_noSkip_Light(nn.Module):
    def __init__(self, channelExponent=6, dropout=0.0):
        super(TurbNetG_noSkip_Light, self).__init__()
        channels = int(2**channelExponent + 0.5)
        #print("Initial Features: ", channels)
